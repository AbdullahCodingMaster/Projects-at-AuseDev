    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <h5>About SolutionX</h5>
                <p>
                    SolutionX provides innovative software solutions tailored to meet the unique needs of businesses, empowering growth and enhancing efficiency. Let us bring your vision to life.
                </p>
            </div>
            <!-- Quick Links -->
            <div class="col-md-4 mb-3">
        ...
        <div class="text-center">
            <p>&copy; 2025 SolutionX. All Rights Reserved.</p>
        </div>
    </div>
</footer>
