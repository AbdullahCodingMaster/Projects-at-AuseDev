    ...
    <div class="container">
        <div id="heroSlider" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <!-- Slide 1 -->
                <div class="carousel-item active" style="background-image: url('assets/images/hero-backend.jpg'); background-size: cover; background-position: center;">
                ...
                <!-- Slide 2 -->
                <div class="carousel-item" style="background-image: url('assets/images/hero-database.jpg'); background-size: cover; background-position: center;">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-md-6">
                ...
                <!-- Slide 3 -->
                <div class="carousel-item" style="background-image: url('assets/images/hero-frontend.jpg'); background-size: cover; background-position: center;">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-md-6">
...
<section class="about-section py-5 bg-light">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <img src="assets/images/hero-backend.jpg" alt="About Us" class="img-fluid rounded shadow-lg">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="testimonial-card bg-light p-4 rounded shadow-lg text-center">
                    <img src="assets/testimonial1.jpg" alt="Client 1" class="rounded-circle mb-3" style="width: 100px; height: 100px;">
            ...
            <div class="col-md-4 mb-4">
                <div class="testimonial-card bg-light p-4 rounded shadow-lg text-center">
                    <img src="assets/testimonial2.jpg" alt="Client 2" class="rounded-circle mb-3" style="width: 100px; height: 100px;">
            ...
            <div class="col-md-4 mb-4">
                <div class="testimonial-card bg-light p-4 rounded shadow-lg text-center">
                    <img src="assets/testimonial3.jpg" alt="Client 3" class="rounded-circle mb-3" style="width: 100px; height: 100px;">
